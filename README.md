...
新加坡科技研究局(A*STAR)资深 AI 研究员,奇点智能研究院特聘专家,专注于 AI Agent 系统设计、大模型工程化与企业级 AI 应用研究。他提出了"**双轴 Agent 设计框架**"(认知功能 × 执行拓扑)和"**模式选择卡**"方法论,用于指导复杂 Agent 系统的设计、拆解与落地。
...
SDD 行动营完整四周材料,作为本书第 3 章工具链全景与第 7-8 章实战路径的延伸演练。
...
**SDD 与 Agent 设计模式怎么结合**——本书第 8 章 + 行动营 [Week 4](./week4/) Superpowers 实操。
